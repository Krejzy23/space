...
export function BlackHole(props: JSX.IntrinsicElements['group']) {
  ...
  const { nodes, materials, animations } = useGLTF('/models/blackhole.glb') as GLTFResult
  const { actions } = useAnimations(animations, group as React.MutableRefObject<THREE.Group>)
